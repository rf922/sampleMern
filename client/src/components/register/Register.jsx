...
const Register = () => {
    ...
    const handleRegister = async () =>{
        if(!isValidForm(username, password, confirmPassword)){
            alert("Invalid form data");4
            return;
        }
        try {
            const result = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/user/register`, {username, password});
    ...
    return (
        <div className="Register">
            <div className="register-card">
                ...
                <input type="password" placeholder="Type your password" id="confirm-password" onChange={(e) => {setConfirmPassword(e.target.value)}}/>
                <br />
